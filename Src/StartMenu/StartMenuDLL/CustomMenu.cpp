...
CStdCommand7 g_StdCommands7[] = {
	...
	{
		L"help",IDS_HELP_ITEM, L"$Menu.Help", L"$Menu.HelpTip", L"imageres.dll,99",NULL,NULL, 0,
		CStdCommand7::ITEM_SINGLE
	},
	{L"run",IDS_RUN_ITEM, L"$Menu.Run", L"$Menu.RunTip", L"imageres.dll,100",NULL,NULL, 0, CStdCommand7::ITEM_SINGLE},
	{
		L"windows_security",IDS_SECURITY_ITEM, L"$Menu.Security", L"$Menu.SecurityTip", L"shell32.dll,48",NULL,NULL, 0,
		CStdCommand7::ITEM_SINGLE
	},
	...
	{
		L"control_panel", 0, L"$Menu.ControlPanel", L"$Menu.ControlPanelTip",NULL, &FOLDERID_ControlPanelFolder,NULL,
		StdMenuItem::MENU_TRACK
	},
	{
		L"pc_settings",IDS_PCSETTINGS, L"$Menu.PCSettings", L"",NULL,NULL,
	...
	{
		L"network_connections", 0,NULL, L"$Menu.NetworkTip",NULL, &FOLDERID_ConnectionsFolder,NULL, 0,
	...
	{
		L"admin", 0,NULL, L"$Menu.AdminToolsTip", L"imageres.dll,114", &FOLDERID_CommonAdminTools,NULL,
		StdMenuItem::MENU_TRACK, CStdCommand7::ITEM_NODRIVES
	},
	...
	{
		L"devices", 0,NULL,NULL,NULL,NULL,
		L"::{26EE0668-A00A-44D7-9371-BEB064C98683}\\0\\::{A8A91A66-3A7D-4424-8D24-04E180695C7A}", 0,
		CStdCommand7::ITEM_NODRIVES
	},
	{
		L"defaults", 0,NULL,NULL,NULL,NULL,
		L"::{26EE0668-A00A-44D7-9371-BEB064C98683}\\0\\::{17CD9488-1228-4B2F-88CE-4298E93E0966}", 0,
		CStdCommand7::ITEM_SINGLE
	},
	...
	if (hash != g_MenuItemsHash)
	{
		if (GetSettingInt(L"MenuStyle") == MENU_WIN7)
		{
			...
			for (int i = 1;; i++)
			{
				...
				if (command && (_wcsicmp(command, L"shutdown_box") == 0 || _wcsicmp(command, L"recent_programs") == 0 ||
					_wcsicmp(command, L"search_box") == 0 || _wcsicmp(command, L"programs") == 0))
				{
			...
			if (GetWinVersion() < WIN_VER_WIN8 || GetSettingInt(L"ProgramsStyle") == PROGRAMS_INLINE || !GetSettingBool(
				L"AllProgramsMetro"))
